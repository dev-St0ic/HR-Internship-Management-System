...
export default function Sidebar() {
  return (
    <nav
      className="p-7 w-[300px] h-[calc(100vh-2rem)] sticky top-5 bottom-5 m-5 rounded-2xl text-gray-700 shadow-lg"
    ...
    >
      <div className="logo-company flex items-center text-lg font-medium text-gray-700">
        <img
          src="image.png"
          alt=""
          className="size-15 rounded-full p-0 m-0"
          style={{ background: "#7C3EFF" }}
        />
