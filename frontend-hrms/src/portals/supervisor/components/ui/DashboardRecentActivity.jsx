          ...
          <div className="row flex flex-col gap-3">
            ...
            <div className="item flex items-center gap-3">
              ...
              <div className="content">
                ...
                <span className="text-sm text-gray-500">Timed In Late</span>
              </div>
            </div>
            ...
            <div className="item flex items-center gap-3">    
              ...
              <div className="content">
                ...
                <span className="text-sm text-gray-500">Timed In</span>
              </div>
            </div>
            ...
            <div className="item flex items-center gap-3">    
              ...
              <div className="content">
                <h1 className="font-medium text-sm">Jane Smith</h1>
                <span className="text-sm text-gray-500">Timed Out Early</span>
              </div>
            </div>
