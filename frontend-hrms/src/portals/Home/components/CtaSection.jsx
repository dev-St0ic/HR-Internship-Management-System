...
import Reveal from "../../../common/components/ui/Reveal"; // Bring in the magic wrapper
    ...
    return (
        <section className="py-24 px-6 bg-[#EEECF9]">
            <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
                ...
                {/* Apply Now Button lands last at 500ms */}
                <Reveal delay={500}>
                    <Link 
                        to="/create-account"
