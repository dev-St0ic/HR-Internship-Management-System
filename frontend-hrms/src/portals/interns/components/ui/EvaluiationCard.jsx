...
export default function EvaluationCard({ evaluation }) {
  if (!evaluation) return null; // Safeguard against empty data

  return (
    /* ONLY CHANGED WRAPPER: Changed p-8 to p-6, and added flex layout to make height consistent */
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition duration-200 h-full flex flex-col justify-between">
      
      <div>
        {/* Card Header */}
        <div className="flex justify-between items-start mb-6">
          <div>
            <h3 className="text-xl font-bold text-gray-900">{evaluation.internName || "Weekly Review"}</h3>
